# -*- coding: utf-8 -*-
"""mechanics_trainer.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1jnu7jifueqMuKFGIQXp4pSC2yA956OL_
"""

# ✅ mechanics_trainer.py (Full Biot Coupled)
...
class BiotMechanics2D(Problem):
    ...
    def loss_fn(all_params, constraints, external_pressure):
        ...
        dpdx, dpdy = jnp.gradient(external_pressure[:,0].reshape((15,15)))
        dpdx = dpdx.flatten().reshape(-1,1)
        dpdy = dpdy.flatten().reshape(-1,1)
